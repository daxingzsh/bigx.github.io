...
- 证书：信息集成项目管理师（中级），GBase 8a，阿里云（ACP），信息系统项目管理师（高级），PMP
...
- 项目心得：
  ...
  - 由于项目的工期紧张，负责选型的我优先选择了市面上开源的开发框架，采用了rouyi管理后台、通过前后端分离设计，为前端提供了统一的数据接口，数据库使用mysql数据。在该项目中，我的主要工作是负责项目的技术选型，以及小程序与后端接口的设计。整个项目下来也使我对完整的系统设计有了更深的了解。
